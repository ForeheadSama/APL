...
_lr_productions = [
  ...
  ('program -> statement_list','program',1,'p_program','parser_mod.py',137),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','parser_mod.py',144),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parser_mod.py',145),
  ('statement_list -> <empty>','statement_list',0,'p_statement_list','parser_mod.py',146),
  ('statement -> command_stmt EOL','statement',2,'p_statement','parser_mod.py',155),
  ('statement -> declaration_stmt EOL','statement',2,'p_statement','parser_mod.py',156),
  ('statement -> if_stmt','statement',1,'p_statement','parser_mod.py',157),
  ('declaration_stmt -> STRING_TYPE IDENTIFIER EQUALS STRING_LITERAL','declaration_stmt',4,'p_declaration_stmt','parser_mod.py',164),
  ('declaration_stmt -> INT_TYPE IDENTIFIER EQUALS NUMBER','declaration_stmt',4,'p_declaration_stmt','parser_mod.py',165),
  ('declaration_stmt -> DATE_TYPE IDENTIFIER EQUALS DATE_VAL','declaration_stmt',4,'p_declaration_stmt','parser_mod.py',166),
  ('if_stmt -> if_then_stmt','if_stmt',1,'p_if_stmt','parser_mod.py',181),
  ('if_stmt -> if_then_else_stmt','if_stmt',1,'p_if_stmt','parser_mod.py',182),
  ('if_then_stmt -> IF LPAREN condition RPAREN LBRACKET statement_list RBRACKET','if_then_stmt',7,'p_if_then_stmt','parser_mod.py',186),
  ('if_then_else_stmt -> IF LPAREN condition RPAREN LBRACKET statement_list RBRACKET ELSE LBRACKET statement_list RBRACKET','if_then_else_stmt',11,'p_if_then_else_stmt','parser_mod.py',196),
  ('condition -> expression GT expression','condition',3,'p_condition','parser_mod.py',207),
  ('condition -> expression LT expression','condition',3,'p_condition','parser_mod.py',208),
  ('condition -> expression GE expression','condition',3,'p_condition','parser_mod.py',209),
  ('condition -> expression LE expression','condition',3,'p_condition','parser_mod.py',210),
  ('condition -> expression EQ expression','condition',3,'p_condition','parser_mod.py',211),
  ('condition -> expression NE expression','condition',3,'p_condition','parser_mod.py',212),
  ('expression -> IDENTIFIER','expression',1,'p_expression','parser_mod.py',220),
  ('expression -> NUMBER','expression',1,'p_expression','parser_mod.py',221),
  ('expression -> STRING_LITERAL','expression',1,'p_expression','parser_mod.py',222),
  ('expression -> DATE_VAL','expression',1,'p_expression','parser_mod.py',223),
  ('command_stmt -> book_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',242),
  ('command_stmt -> cancel_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',243),
  ('command_stmt -> list_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',244),
  ('command_stmt -> check_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',245),
  ('command_stmt -> pay_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',246),
  ('command_stmt -> display_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',247),
  ('command_stmt -> accept_cmd','command_stmt',1,'p_command_stmt','parser_mod.py',248),
  ('book_cmd -> BOOK quantity TICKETS FOR customer ON date FOR event','book_cmd',9,'p_book_cmd','parser_mod.py',253),
  ('quantity -> NUMBER','quantity',1,'p_quantity','parser_mod.py',266),
  ('quantity -> IDENTIFIER','quantity',1,'p_quantity','parser_mod.py',267),
  ('customer -> STRING_LITERAL','customer',1,'p_customer','parser_mod.py',278),
  ('customer -> IDENTIFIER','customer',1,'p_customer','parser_mod.py',279),
  ('date -> DATE_VAL','date',1,'p_date','parser_mod.py',290),
  ('date -> IDENTIFIER','date',1,'p_date','parser_mod.py',291),
  ('event -> STRING_LITERAL','event',1,'p_event','parser_mod.py',302),
  ('event -> IDENTIFIER','event',1,'p_event','parser_mod.py',303),
  ('cancel_cmd -> CANCEL ticket_or_tickets FOR customer EVENT event','cancel_cmd',6,'p_cancel_cmd','parser_mod.py',315),
  ('ticket_or_tickets -> TICKET','ticket_or_tickets',1,'p_ticket_or_tickets','parser_mod.py',321),
  ('ticket_or_tickets -> TICKETS','ticket_or_tickets',1,'p_ticket_or_tickets','parser_mod.py',322),
  ('list_cmd -> LIST EVENTS ON date','list_cmd',4,'p_list_cmd','parser_mod.py',327),
  ('list_cmd -> LIST EVENTS FOR event','list_cmd',4,'p_list_cmd','parser_mod.py',328),
  ('check_cmd -> CHECK AVAILABILITY FOR event ON date','check_cmd',6,'p_check_cmd','parser_mod.py',343),
  ('check_cmd -> CHECK PRICE FOR event ON date','check_cmd',6,'p_check_cmd','parser_mod.py',344),
  ('pay_cmd -> PAY FOR event customer','pay_cmd',4,'p_pay_cmd','parser_mod.py',353),
  ('display_cmd -> DISPLAY message','display_cmd',2,'p_display_cmd','parser_mod.py',361),
  ('message -> STRING_LITERAL','message',1,'p_message','parser_mod.py',368),
  ('message -> IDENTIFIER','message',1,'p_message','parser_mod.py',369),
  ('accept_cmd -> ACCEPT IDENTIFIER','accept_cmd',2,'p_accept_cmd','parser_mod.py',381),
  ('EOL -> DOT','EOL',1,'p_EOL','parser_mod.py',398),
]
